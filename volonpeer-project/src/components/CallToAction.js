export default function Example() {
    return (
      <div className="">
        <div className="max-w-7xl mx-auto py-12 mt-10 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            <span className="block">Ready to dive in?</span>
            <span className="block text-greenish6">Start your free journey today.</span>
          </h2>
